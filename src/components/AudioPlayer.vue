<template>
    <div class="bg-white rounded-xl border border-gray-200 p-5">
        ...
        <div class="flex items-center gap-3 bg-gray-50 rounded-lg px-4 py-3">
            <!-- 播放/暂停按钮 -->
            <button
                class="w-10 h-10 flex items-center justify-center rounded-full bg-primary text-white hover:opacity-90 transition-opacity shrink-0 disabled:opacity-50 disabled:cursor-not-allowed"
                :disabled="!canPlay"
                @click="togglePlay"
            >
                <el-icon :size="18">
